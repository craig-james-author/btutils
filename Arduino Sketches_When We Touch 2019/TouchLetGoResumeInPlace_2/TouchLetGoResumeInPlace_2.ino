...
/*******************************************************************************
// Description: Touching a sensor triggers each track. If you touch the same sensor, it resumes in place. 
There seems to be no “time out”. But if you touch another sensor, the previous one starts at the beginning when touched.
